...
public class ProductAdapter {
    ...
    protected String priceXpath = "product:price";

    protected String availabiltyXpath = "product:availability";
    ...
    public void setPrice(double value) {
        doc.setPropertyValue(priceXpath, value);
    }

    public boolean getAvailability() {return (boolean) doc.getPropertyValue(availabiltyXpath);}

    public void setAvailability(boolean value) {
        doc.setPropertyValue(availabiltyXpath, value);
    }
}
